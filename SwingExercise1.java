...
public class SwingExercise1 {
	public static void main(String[] args) {
        ...
        ImageIcon clockIcon = new ImageIcon(SwingExercise1.class.getResource("clock.png"));
        ImageIcon hourGlassIcon = new ImageIcon(SwingExercise1.class.getResource("hourglass.png"));
